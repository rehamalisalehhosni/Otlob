...
class OrderDetailsControllerTest < ActionController::TestCase
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post :create, order_detail: { amount: @order_detail.amount, comment: @order_detail.comment, item: @order_detail.item, price: @order_detail.price }
    end
  ...
  test "should update order_detail" do
    patch :update, id: @order_detail, order_detail: { amount: @order_detail.amount, comment: @order_detail.comment, item: @order_detail.item, price: @order_detail.price }
    assert_redirected_to order_detail_path(assigns(:order_detail))
  end
